...
jQuery( document ).ready( function( $ ) {
  $( '#amcharts-location-remote' ).click( function() {
    $( '#amcharts-path-group,#amcharts-live-editor-group,#amcharts-relative-urls-group' ).fadeOut();
  } );

  $( '#amcharts-location-local' ).click( function() {
    $( '#amcharts-path-group,#amcharts-live-editor-group,#amcharts-relative-urls-group' ).fadeIn();
  } );
  ...
  $( 'textarea.code' ).each( function() {
    ...
    if (wp.CodeMirror) {
      amcharts_code[ this.name ] = wp.CodeMirror.fromTextArea( this, cfg );
    }
    else {
